    ...
    <section className="container mx-auto flex flex-col lg:flex-row items-center gap-12 px-6 py-12">
      ...
      <div className="w-full lg:w-1/2">
        ...
        <p className="text-gray-700 mb-4">
          ...
          are committed to providing pieces that are effortlessly chic, easy to
          wear, and true to who you are.
        </p>
        <p className="text-gray-700 mb-4">
          At Just Clothing, we focus on creating versatile and comfortable
          clothing with the modern individual in mind—someone who values quality
          and comfort. Each collection is designed with modern and effortless
          style in mind, and crafted from quality fabrics to ensure lasting
          wear.
        </p>
        <p className="text-gray-700 mb-4">
          In a world of fast fashion, we focus on quality over quantity,
          offering pieces that stand the test of time. Our journey is rooted in
          simplicity, and we are proud to share it with you.
        </p>
